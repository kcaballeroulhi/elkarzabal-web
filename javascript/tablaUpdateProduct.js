...
$(document).ready(function () {
    ...
    for (i in productos) {
        ...
        var tr2 = $("<tr><td>"
            ...
            + "<button class='bUProduct' onclick=updateProduct(" + productID + ")>Modificar</button></td><td>"
            + "<button class='bUProduct' onclick=deleteProduct(" + productID + ")>Eliminar</button></td><td>");
